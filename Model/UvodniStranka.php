        ...
        'dataSekce' => [
            [
                'sloupec' =>[
                    ...
                    [
                        'ctenar' => 'Mgr. Zdeňka Vápeníková, zástupce ředitele SŠ, Havířov:',
                        'ohlas' => '„Dobrý den, na školu dorazil průvodce pro absolventy SŠ - Plav! Chtěla jsem Vám, jménem vedení školy, mockrát poděkovat. Myslím, že to byl
                                    výborný nápad, dát všechny tyhle rady dohromady a vydat takovou pěknou knížku. Knihy moc ráda předám našim maturantům. Ať se Vám i nadále 
                                    v práci daří a spoustu dalších dobrých nápadů.“'
                    ]
                ]
            ], [ 
                'sloupec' => [
